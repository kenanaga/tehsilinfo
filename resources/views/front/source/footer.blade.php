       ...
       <div class="container">
          <div class="footer-bottom-area d-flex align-items-center justify-content-center">
             <p class="copyright-text mb-0 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="800ms">
                <span class="currentYear"></span> © Bütün hüquqlar qorunur
                <a href="https://www.tehsil.info/" rel="nofollow">Tehsil.info</a>
             </p>
          </div>
       </div>
    </div>
    ...
    <ul class="cart-items ">
       <li class="d-flex ">
          <div class="item-figure">
             <a href="#">
                <img src="{{asset('front/media/gallery/ins-gallery_1.jpg')}}" alt="Cart" width="100" height="90">
             </a>
...
<script src="{{ asset('front/dependencies/appear/appear.min.js') }}"></script>
<script src="{{ asset('front/dependencies/swiper/js/swiper.min.js') }}"></script>
<script src="{{ asset('front/dependencies/masonry/masonry.min.js') }}"></script>
<script src="{{ asset('front/dependencies/magnific-popup/js/magnific-popup.min.js') }}"></script>
<script src="{{ asset('front/dependencies/theia-sticky-sidebar/resize-sensor.min.js') }}"></script>
<script src="{{ asset('front/dependencies/theia-sticky-sidebar/theia-sticky-sidebar.min.js') }}"></script>
<script src="{{ asset('front/dependencies/validator/validator.min.js') }}"></script>
<script src="{{ asset('front/dependencies/tween-max/tween-max.js') }}"></script>
